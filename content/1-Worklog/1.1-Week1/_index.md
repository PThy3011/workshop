...
#### WEEK 1 (From 17/04/2026 to 23/04/2026)
...
### Week 1 Achievements:
* Understood what AWS is and mastered the core service pillars: Compute, Storage, Networking, and Database.
* Successfully created and secured an AWS Free Tier account with initial safety configurations.
* Became familiar with the AWS Management Console to search, access, and check the status of various cloud resources.
* Successfully installed the AWS CLI tool on a local machine, configuring the Access Key, Secret Key, and Default Region Name.
* Mastered basic CLI commands to inspect account profile configurations, active region lists, and active services.
* Understood cost management principles and successfully configured **AWS Budgets** with automated email alerts to prevent resource waste.